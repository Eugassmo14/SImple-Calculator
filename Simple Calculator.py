...
# Set window title, size, position, and background color
root.title("Eugene Calculator")
root.geometry("570x600+100+200")
root.resizable(False,False)
root.configure(bg="#17163b")


# Create Global variable to store the mathematical expression
equation = ""

# Function to update the expression and display on the calculator screen
def show(value):
    global equation
    equation+=value
...
# Create a label for displaying the calculator screen
label_result= Label(root,width=25,height=2,text="",font=("arial",30))
label_result.pack()

# Buttons for calculator with their respective dimensions and font specifications
